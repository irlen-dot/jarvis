...
class MusicService:
    ...
    def download_video_as_mp3(self, link: str, folder_name: str) -> str:
        ...
        Args:
            ...
            name ("lo-fi" | "singing" | "rap" | "motivation" | "opening" | "electronic"): folder
...
def youtube_to_mp3(link: str, folder: str) -> str:
    ...
    Args:
        link (str): The YouTube video URL to download
        folder ("lo-fi" | "singing" | "rap" | "motivation" | "opening" | "electronic"): The folder in which we have to save the mp3 file. It is an enum
