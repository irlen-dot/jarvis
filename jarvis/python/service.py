...
class ProjectSettings:
    ...
    def full_path(self) -> Path:
        ...
        if not base:
            raise ValueError(
                "Project path not provided and PYTHON_PROJECT_PATH not set"
            )
...
class PoetryEnvironment:
    ...
    def verify_installation() -> None:
        ...
        try:
            ...
            raise EnvironmentError(
                "Poetry is not installed. Please install Poetry and try again."
            )
    ...
    def setup_environment(python_version: str) -> str:
        ...
        commands = [["poetry", "env", "use", python_version], ["poetry", "shell"]]
...
class PythonProjectManager:
    ...
    def create_project(self, settings: ProjectSettings) -> Path:
        ...
        try:
            ...
            interpreter_path = PoetryEnvironment.setup_environment(
            ...
            if interpreter_path:
                ...
                print(
                    "Warning: Failed to get interpreter path. VS Code settings not configured."
                )
...
def create_python_project(project_name: str, project_path: str = None) -> str:
    ...
    settings = ProjectSettings(name=project_name, base_path=project_path)
